...
ADJECTIVES: list = ["amazing", "funny", "boring", "exciting", "weird", "exuberant", "garrulous", "enticing", "disgusting"]
ACTIONS: list = ["found", "saw", "tried", "shared", "loved", "hated", "created", "built", "launched"]
TOPICS: list = ["a movie", "a meme", "an app", "a trick", "a story", "a game", "a book", "a script", "a song"]
